...
$addressType = isset($_SESSION['address_type']) ? $_SESSION['address_type'] : 'WORK';
$customerName = isset($_SESSION['customer_name']) ? $_SESSION['customer_name'] : 'Mayuri Wanjari';
$address = isset($_SESSION['address']) ? $_SESSION['address'] : 'Government Polytechnic, Near Gajanan mandir, Sakoli 441802';
$phone = isset($_SESSION['phone']) ? $_SESSION['phone'] : '9322855146';
